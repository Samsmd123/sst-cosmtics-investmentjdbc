...
public class InvestmentController {
	...
	public String homePage(Model model) {
		List<Investment>invesments=investmentService.getAll();
		model.addAttribute("investments",invesments);
		return "index";
	}
	...
	public String addInvestment(@RequestParam("planId")int planId) {
